...
export type SourceState = 'liefert' | 'bereit' | 'blockiert' | 'übersprungen' | 'nicht gebaut' | 'kein Token'
...
export interface IntSource {
  ...
  blocked: string | null // eingerichtet, aber nachweislich nicht benutzbar — mit Grund
  state: SourceState
}
