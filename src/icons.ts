import {
  ...
  Box, HardDrive, Mail, Calendar, GitBranch, FileText, MessageSquare, Circle, Asterisk, Inbox, Folder, FolderOpen,
} from 'lucide-react'
...
export const ICONS: Record<string, LucideIcon> = {
  ...
  circle: Circle, asterisk: Asterisk, inbox: Inbox, folder: Folder, 'folder-open': FolderOpen,
}
